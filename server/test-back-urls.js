...
console.log('🔍 VERIFICANDO BACK_URLS DE PREFERENCIAS');
console.log('========================================');
...
async function testBackUrls() {
  try {
    console.log('🧪 Creando preferencia de prueba con back_urls...');
    ...
    console.log('4. Verifica que llegue a tu aplicación');
